...
* Current Release Candidate version: v1.0.0
...
* Report any bugs or problems you encounter to the issue tracker http://github.com/VSEphpbb/password_strength/issues

== REQUIREMENTS:

* phpBB 3.0.8 or greater
