		...
		function toggleField(field, level)
		{
			...
			switch (level)
			{
				...
				case 1: 
					...
					$("#" + field + "text").html(ps_1).css("display", "block");
				break;

				case 2: 
					$("#" + field).css("background-color","#F5D0A9"); //orange
					$("#" + field + "text").html(ps_2).css("display", "block");
				break;

				case 3: 
					$("#" + field).css("background-color","#F3F781"); //yellow
					$("#" + field + "text").html(ps_3).css("display", "block");
				break;

				case 4: 
					$("#" + field).css("background-color","#A9F5A9"); //green
					$("#" + field + "text").html(ps_4).css("display", "block");
				break;

				case 5: 
					$("#" + field).css("background-color","#A9F5A9"); //green
					$("#" + field + "text").html(ps_5).css("display", "block");
				break;
			}
		}
